This Compatibility Matrix details supported platforms in Eucalyptus 3.4 software.<br><br>For a list of other versions [click here](Eucalyptus-Cloud-Compatibility-Matrix---Overview).
